...
sap.ui.core.UIComponent.extend("com.springer.pimonitoring.Component", {
	metadata: {
		...
		rootView: "com.springer.pimonitoring.view.App",

		config: {
			resourceBundle: "i18n/messageBundle.properties",
			serviceConfig: {
				name: "ZPI_MONITOR_APP_SRV",
				serviceUrl: "/sap/opu/odata/sap/ZPI_MONITOR_APP_SRV/"
			}
		},

		routing: {
			config: {
				routerClass: com.springer.pimonitoring.MyRouter,
				viewType: "XML",
				viewPath: "com.springer.pimonitoring.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.springer.pimonitoring");
		...
		var oModel;
		var externalURL = com.springer.pimonitoring.dev.devapp.externalURL;
		var appContext;
		if (com.springer.pimonitoring.dev.devapp.devLogon) {
			appContext = com.springer.pimonitoring.dev.devapp.devLogon.appContext;
		}
